...
public class ChooseShopOtherEventBooking extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_shop_other_event_booking);
        //bar
        ...
        grid3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(textShop)) {
                    Toast.makeText(ChooseShopOtherEventBooking.this, "Choose the shop", Toast.LENGTH_SHORT).show();
    ...
    private void addUserShopBooking(String shop) {
        ...
        OthersEventBookingClass othersEventBookingClass = new OthersEventBookingClass(null, null, shop, null);

        reference.child(firebaseuser.getUid()).child(shop).setValue(othersEventBookingClass).addOnCompleteListener( new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull com.google.android.gms.tasks.Task<Void> task) {

                Toast.makeText(ChooseShopOtherEventBooking.this, "Yah Catering", Toast.LENGTH_LONG).show();
                Intent intent = new Intent (ChooseShopOtherEventBooking.this, ShopOthersEvent1.class);
