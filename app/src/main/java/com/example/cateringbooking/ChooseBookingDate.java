...
public class ChooseBookingDate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText_ChooseDateBooking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //date picker dialog
                picker = new DatePickerDialog(ChooseBookingDate.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        button_ChooseDateBooking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(textDate)) {
                    Toast.makeText(ChooseBookingDate.this, "Please insert your date of booking", Toast.LENGTH_SHORT).show();
    ...
    private void addUserDateBooking(String textDate) {
        ...
        WeddingBooking_class weddingBookingClass = new WeddingBooking_class(id, null, textDate, null, null, null, null);

        reference.child(firebaseuser.getUid()).child(id).setValue(weddingBookingClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {

                Toast.makeText(ChooseBookingDate.this, "Choose Your Date", Toast.LENGTH_LONG).show();
                Intent intent = new Intent (ChooseBookingDate.this, ChooseShop.class);
