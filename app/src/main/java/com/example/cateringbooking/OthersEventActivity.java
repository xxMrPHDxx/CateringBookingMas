...
public class OthersEventActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //bar
        getSupportActionBar().setTitle("Others Event");
        ActionBar actionBar;
        ...
        editText_ChooseDateBooking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //date picker dialog
                picker = new DatePickerDialog(OthersEventActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        button_ChooseDateBooking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(textDate)) {
                    Toast.makeText(OthersEventActivity.this, "Please insert your date of booking", Toast.LENGTH_SHORT).show();
    ...
    private void addUserDateBooking(String textDate) {
        ...
        OthersEventBookingClass othersEventBookingClass = new OthersEventBookingClass(id, textDate, null, null);

        reference.child(firebaseuser.getUid()).child(id).setValue(othersEventBookingClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {

                Toast.makeText(OthersEventActivity.this, "Choose Your Date", Toast.LENGTH_LONG).show();
                Intent intent = new Intent (OthersEventActivity.this, ChooseShopOtherEventBooking.class);
